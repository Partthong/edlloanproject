...
function InvoiceWithdraw() {
    ...
    const InsertData = async () => {
        try {
            ...
            const response = await axiosInterceptorInstance.post('/api/invoicewithdraw/InsertInvoiceWithdraw', raw);
    ...
    const rightToolbarTemplate = () => {
        return (
            <React.Fragment>
                ...
                <Button label="ແກ້ໄຂຂໍ້ມູນ" icon="pi pi-pencil" className="mr-2 p-button-secondary" />
            </React.Fragment>
        );
    };
                ...
                <div className="card ">
                    ...
                    <div className="p-fluid formgrid grid">
                        ...
                        <div className="field col-12 md:col-4">
                            ...
                            <InputNumber className="" readOnly id="firstname2" type="text" value={selectedLoan ? selectedLoan.amount_loan : ''} />
                        </div>
                        <div className="field col-12 md:col-4">
                            <label htmlFor="firstname2" className="">
                            ...
                            <InputNumber className="" readOnly id="firstname2" type="text" value={selectedLoan ? selectedLoan.total_withdraw : ''} />
                ...
                <div className="card ">
                    <div className=" p-fluid formgrid grid">
                        <div className="field col-12 md:col-4">
                            ...
                            <InputText id="invoicew_no" type="text" className="text-blue-500" onChange={(e) => setInsertInvoice({ ...insertInvoice, invoicew_no: e.target.value })} />
                        </div>
                        <div className="field col-12 md:col-4">
                            <label htmlFor="name1">ຈຳນວນເງິນຖອນ</label>
                            <InputNumber value={insertInvoice.invamount_withdraw} onValueChange={(e) => onInputNumberChange(e, 'invamount_withdraw')} />
                        </div>

                        <div className="field col-12 md:col-4">
                            <label htmlFor="age1">ວັນເດືອນປີ</label>
                            <Calendar dateFormat="yy-mm-dd" onChange={(e) => setInsertInvoice({ ...insertInvoice, date_inv1: e.target.value })} showIcon />
                        </div>
                    </div>
                </div>
            </div>
