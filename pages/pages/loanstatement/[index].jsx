...
const LoanStatement = () => {
  ...
  const Getloanno = router.query.index;


    useEffect(() => {
        showListpaymentbyLoanID();
    }, [Getloanno]);

    const showListpaymentbyLoanID = async () => {
        try {

            const response = await axiosInterceptorInstance.get('/api/payment/GetListpaymentbyLoanID?loan_no=' + Getloanno);
    ...
    const leftToolbarTemplate = () => {
        return (
            <React.Fragment>
                <div className="my-2">
                    <h4 className="font-semibold  text-blue-700"> ການເຄື່ອນໄຫວຊຳລະໜີ້</h4>
                </div>
            </React.Fragment>
        );
    };
                ...
                <div className="flex flex-column xl:flex-row xl:align-items-start p-4 gap-4">
                    ...
                    <div className="flex flex-column sm:flex-row justify-content-between align-items-center xl:align-items-start flex-1 gap-4">
                        <div className="flex flex-column align-items-center sm:align-items-start gap-3">
                            <div className="text-2xl font-bold text-900">{payment.project}</div>
        ...
        <div className="grid">
            <div className="col-12">
                ...
                <div className="card">
                    ...
                    <div className="card">
                        <DataView value={payments} itemTemplate={itemTemplate} paginator rows={5} />
                    </div>

                    <Dialog visible={paymentDialog} style={{ width: '450px' }} header="ລາຍລະອຽດການຊຳລະ" modal className="p-fluid" footer={paymentsDialogFooter} onHide={hideDialog}>
                        <div className="mb-3">
                            <div className="text-right">{payment?.payment_date}</div>
                            <img className="w-6 sm:w-12rem xl:w-6rem  block xl:block mx-auto border-round" src="/layout/images/check.png" alt="" />
                        </div>
